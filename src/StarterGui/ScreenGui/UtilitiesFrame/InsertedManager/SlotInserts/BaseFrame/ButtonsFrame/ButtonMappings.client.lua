...
local button4lock: TextButton = script.Parent:FindFirstChild('4LockButton')
local button5destroy: TextButton = script.Parent:FindFirstChild('5DestroyButton')
...
button4lock.MouseEnter:Connect(function(x, y)
	onButtonMouseEnter(button4lock, 'Un/Lock car')
end)
button5destroy.MouseEnter:Connect(function(x, y)
	onButtonMouseEnter(button5destroy, 'Destroy car')
end)
...
button4lock.MouseLeave:Connect(function(x, y)
	onButtonMouseLeave(button3respawn, 'Un/Lock car')
end)
button5destroy.MouseLeave:Connect(function(x, y)
	onButtonMouseLeave(button5destroy, 'Bring car')
end)
...
button4lock.Activated:Connect(function()
	ManageRequest:FireServer(script.Parent.Parent:GetAttribute('asset_special_id'), 'un/lock')
end)
button5destroy.Activated:Connect(function()
